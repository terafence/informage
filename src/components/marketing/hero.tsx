    ...
    <section className="relative w-full min-h-screen overflow-hidden">
      {!videoPlaying ? (
        <>
          ...
          >
            <source
              src="/images/hero/cybersecurity-operations.mp4"
              type="video/mp4"
            />
          </video>
          ...
          <div className="relative z-2git0 flex flex-col items-center justify-center h-screen px-6">
            ...
            >
              ...
              <motion.p
                ...
                className="text-xl md:text-2xl mb-24 text-white/80 max-w-3xl mx-auto font-light"
              >
                Resilient Defense, Secure Cyber Future.{" "}
              </motion.p>
        ...
        <div className="relative z-50 flex items-center justify-center h-screen bg-black">
          <div className="w-full max-w-6xl aspect-video relative">
            <video className="w-full h-full" controls autoPlay>
              <source
                src="/images/hero/promotional-video.mp4"
                type="video/mp4"
              />
            </video>
            <Button
