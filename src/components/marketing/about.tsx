    ...
    >
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-6">
        ...
        >
          ...
          >
            <span className="text-emerald-400 font-normal">Our team</span>{" "}
            specializes in advanced defense, IT, and cybersecurity solutions —
            offering cutting-edge technologies for threat detection, protection,
            uncrewed system defense, and resilience against spoofing, jamming,
            and cyberattacks.
          </motion.p>
          ...
          >
            With extensive industry experience and strong technical expertise,
            our team is dedicated to building solutions that tackle the most
            complex challenges across modern defense, IT infrastructure, and
